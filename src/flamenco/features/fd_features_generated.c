...
fd_feature_id_t const ids[] = {
  ...
  { .index      = offsetof(fd_features_t, devnet_and_testnet)>>3,
    ...
    .name       = "devnet_and_testnet",
    .cleaned_up = {UINT_MAX, UINT_MAX, UINT_MAX} },

  { .index      = offsetof(fd_features_t, full_inflation_vote)>>3,
    ...
    .name       = "full_inflation_vote",
    .cleaned_up = {UINT_MAX, UINT_MAX, UINT_MAX} },

  { .index      = offsetof(fd_features_t, full_inflation_enable)>>3,
  ...
  { .index      = offsetof(fd_features_t, secp256k1_program_enabled)>>3,
    ...
    .name       = "secp256k1_program_enabled",
    .cleaned_up = {1, 18, 0} },
  ...
  { .index      = offsetof(fd_features_t, spl_token_v2_multisig_fix)>>3,
    ...
    .name       = "spl_token_v2_multisig_fix",
    .cleaned_up = {1, 18, 0} },
  ...
  { .index      = offsetof(fd_features_t, no_overflow_rent_distribution)>>3,
    ...
    .name       = "no_overflow_rent_distribution",
    .cleaned_up = {1, 18, 0} },
  ...
  { .index      = offsetof(fd_features_t, filter_stake_delegation_accounts)>>3,
    ...
    .name       = "filter_stake_delegation_accounts",
    .cleaned_up = {1, 18, 0} },
  ...
  { .index      = offsetof(fd_features_t, require_custodian_for_locked_stake_authorize)>>3,
    ...
    .name       = "require_custodian_for_locked_stake_authorize",
    .cleaned_up = {1, 18, 0} },
  ...
  { .index      = offsetof(fd_features_t, spl_token_v2_self_transfer_fix)>>3,
    ...
    .name       = "spl_token_v2_self_transfer_fix",
    .cleaned_up = {1, 18, 0} },
  ...
  { .index      = offsetof(fd_features_t, secp256k1_recover_syscall_enabled)>>3,
    ...
    .name       = "secp256k1_recover_syscall_enabled",
    .cleaned_up = {1, 18, 0} },
  ...
  { .index      = offsetof(fd_features_t, dedupe_config_program_signers)>>3,
    ...
    .name       = "dedupe_config_program_signers",
    .cleaned_up = {1, 18, 0} },
  ...
  { .index      = offsetof(fd_features_t, libsecp256k1_0_5_upgrade_enabled)>>3,
    ...
    .name       = "libsecp256k1_0_5_upgrade_enabled",
    .cleaned_up = {1, 18, 0} },
  ...
  { .index      = offsetof(fd_features_t, spl_token_v2_set_authority_fix)>>3,
    ...
    .name       = "spl_token_v2_set_authority_fix",
    .cleaned_up = {1, 18, 0} },
  ...
  { .index      = offsetof(fd_features_t, merge_nonce_error_into_system_error)>>3,
    ...
    .name       = "merge_nonce_error_into_system_error",
    .cleaned_up = {1, 18, 0} },
  ...
  { .index      = offsetof(fd_features_t, curve25519_syscall_enabled)>>3,
    ...
    .name       = "curve25519_syscall_enabled",
    .cleaned_up = {UINT_MAX, UINT_MAX, UINT_MAX} },
  ...
  { .index      = offsetof(fd_features_t, versioned_tx_message_enabled)>>3,
    ...
    .name       = "versioned_tx_message_enabled",
    .cleaned_up = {1, 18, 0} },
  ...
  { .index      = offsetof(fd_features_t, demote_program_write_locks)>>3,
    ...
    .name       = "demote_program_write_locks",
    .cleaned_up = {1, 18, 0} },
  ...
  { .index      = offsetof(fd_features_t, return_data_syscall_enabled)>>3,
    ...
    .name       = "return_data_syscall_enabled",
    .cleaned_up = {1, 18, 0} },
  ...
  { .index      = offsetof(fd_features_t, reduce_required_deploy_balance)>>3,
    ...
    .name       = "reduce_required_deploy_balance",
    .cleaned_up = {1, 18, 0} },
  ...
  { .index      = offsetof(fd_features_t, sol_log_data_syscall_enabled)>>3,
    ...
    .name       = "sol_log_data_syscall_enabled",
    .cleaned_up = {1, 18, 0} },
  ...
  { .index      = offsetof(fd_features_t, optimize_epoch_boundary_updates)>>3,
    ...
    .name       = "optimize_epoch_boundary_updates",
    .cleaned_up = {1, 18, 0} },
  ...
  { .index      = offsetof(fd_features_t, add_compute_budget_program)>>3,
    ...
    .name       = "add_compute_budget_program",
    .cleaned_up = {1, 18, 0} },
  ...
  { .index      = offsetof(fd_features_t, reject_empty_instruction_without_program)>>3,
    ...
    .name       = "reject_empty_instruction_without_program",
    .cleaned_up = {1, 18, 0} },
  ...
  { .index      = offsetof(fd_features_t, fixed_memcpy_nonoverlapping_check)>>3,
    ...
    .name       = "fixed_memcpy_nonoverlapping_check",
    .cleaned_up = {1, 18, 0} },
  ...
  { .index      = offsetof(fd_features_t, require_rent_exempt_accounts)>>3,
    ...
    .name       = "require_rent_exempt_accounts",
    .cleaned_up = {1, 18, 0} },
  ...
  { .index      = offsetof(fd_features_t, filter_votes_outside_slot_hashes)>>3,
    ...
    .name       = "filter_votes_outside_slot_hashes",
    .cleaned_up = {1, 18, 0} },
  ...
  { .index      = offsetof(fd_features_t, update_syscall_base_costs)>>3,
    ...
    .name       = "update_syscall_base_costs",
    .cleaned_up = {1, 18, 0} },
  ...
  { .index      = offsetof(fd_features_t, vote_withdraw_authority_may_change_authorized_voter)>>3,
    ...
    .name       = "vote_withdraw_authority_may_change_authorized_voter",
    .cleaned_up = {1, 18, 0} },
  ...
  { .index      = offsetof(fd_features_t, add_get_processed_sibling_instruction_syscall)>>3,
    ...
    .name       = "add_get_processed_sibling_instruction_syscall",
    .cleaned_up = {1, 18, 0} },
  ...
  { .index      = offsetof(fd_features_t, bank_transaction_count_fix)>>3,
    ...
    .name       = "bank_transaction_count_fix",
    .cleaned_up = {1, 18, 0} },
  ...
  { .index      = offsetof(fd_features_t, disable_bpf_unresolved_symbols_at_runtime)>>3,
    ...
    .name       = "disable_bpf_unresolved_symbols_at_runtime",
    .cleaned_up = {1, 18, 0} },
  ...
  { .index      = offsetof(fd_features_t, record_instruction_in_transaction_context_push)>>3,
    ...
    .name       = "record_instruction_in_transaction_context_push",
    .cleaned_up = {1, 18, 0} },
  ...
  { .index      = offsetof(fd_features_t, check_physical_overlapping)>>3,
    ...
    .name       = "check_physical_overlapping",
    .cleaned_up = {1, 18, 0} },
  ...
  { .index      = offsetof(fd_features_t, limit_secp256k1_recovery_id)>>3,
    ...
    .name       = "limit_secp256k1_recovery_id",
    .cleaned_up = {1, 18, 0} },
  ...
  { .index      = offsetof(fd_features_t, check_slice_translation_size)>>3,
    ...
    .name       = "check_slice_translation_size",
    .cleaned_up = {1, 18, 0} },
  ...
  { .index      = offsetof(fd_features_t, stake_split_uses_rent_sysvar)>>3,
    ...
    .name       = "stake_split_uses_rent_sysvar",
    .cleaned_up = {1, 18, 0} },
  ...
  { .index      = offsetof(fd_features_t, add_get_minimum_delegation_instruction_to_stake_program)>>3,
    ...
    .name       = "add_get_minimum_delegation_instruction_to_stake_program",
    .cleaned_up = {1, 18, 0} },
  ...
  { .index      = offsetof(fd_features_t, drop_redundant_turbine_path)>>3,
    ...
    .name       = "drop_redundant_turbine_path",
    .cleaned_up = {1, 18, 0} },
  ...
  { .index      = offsetof(fd_features_t, update_rewards_from_cached_accounts)>>3,
    ...
    .name       = "update_rewards_from_cached_accounts",
    .cleaned_up = {1, 18, 0} },
  ...
  { .index      = offsetof(fd_features_t, default_units_per_instruction)>>3,
    ...
    .name       = "default_units_per_instruction",
    .cleaned_up = {1, 18, 0} },
  ...
  { .index      = offsetof(fd_features_t, stake_allow_zero_undelegated_amount)>>3,
    ...
    .name       = "stake_allow_zero_undelegated_amount",
    .cleaned_up = {1, 18, 0} },
  ...
  { .index      = offsetof(fd_features_t, stake_raise_minimum_delegation_to_1_sol)>>3,
    ...
    .name       = "stake_raise_minimum_delegation_to_1_sol",
    .cleaned_up = {UINT_MAX, UINT_MAX, UINT_MAX} },
  ...
  { .index      = offsetof(fd_features_t, disable_deploy_of_alloc_free_syscall)>>3,
    ...
    .name       = "disable_deploy_of_alloc_free_syscall",
    .cleaned_up = {UINT_MAX, UINT_MAX, UINT_MAX} },
  ...
  { .index      = offsetof(fd_features_t, include_account_index_in_rent_error)>>3,
    ...
    .name       = "include_account_index_in_rent_error",
    .cleaned_up = {1, 18, 0} },
  ...
  { .index      = offsetof(fd_features_t, add_shred_type_to_shred_seed)>>3,
    ...
    .name       = "add_shred_type_to_shred_seed",
    .cleaned_up = {1, 18, 0} },
  ...
  { .index      = offsetof(fd_features_t, warp_timestamp_with_a_vengeance)>>3,
    ...
    .name       = "warp_timestamp_with_a_vengeance",
    .cleaned_up = {1, 18, 0} },
  ...
  { .index      = offsetof(fd_features_t, separate_nonce_from_blockhash)>>3,
    ...
    .name       = "separate_nonce_from_blockhash",
    .cleaned_up = {1, 18, 0} },
  ...
  { .index      = offsetof(fd_features_t, nonce_must_be_advanceable)>>3,
    ...
    .name       = "nonce_must_be_advanceable",
    .cleaned_up = {1, 18, 0} },
  ...
  { .index      = offsetof(fd_features_t, enable_bpf_loader_extend_program_ix)>>3,
    ...
    .name       = "enable_bpf_loader_extend_program_ix",
    .cleaned_up = {UINT_MAX, UINT_MAX, UINT_MAX} },
  ...
  { .index      = offsetof(fd_features_t, enable_early_verification_of_account_modifications)>>3,
    ...
    .name       = "enable_early_verification_of_account_modifications",
    .cleaned_up = {1, 18, 0} },
  ...
  { .index      = offsetof(fd_features_t, cap_bpf_program_instruction_accounts)>>3,
    ...
    .name       = "cap_bpf_program_instruction_accounts",
    .cleaned_up = {1, 18, 0} },
  ...
  { .index      = offsetof(fd_features_t, incremental_snapshot_only_incremental_hash_calculation)>>3,
    ...
    .name       = "incremental_snapshot_only_incremental_hash_calculation",
    .cleaned_up = {UINT_MAX, UINT_MAX, UINT_MAX} },
  ...
  { .index      = offsetof(fd_features_t, disable_cpi_setting_executable_and_rent_epoch)>>3,
    ...
    .name       = "disable_cpi_setting_executable_and_rent_epoch",
    .cleaned_up = {1, 18, 0} },
  ...
  { .index      = offsetof(fd_features_t, vote_state_update_root_fix)>>3,
    ...
    .name       = "vote_state_update_root_fix",
    .cleaned_up = {1, 18, 0} },
  ...
  { .index      = offsetof(fd_features_t, remove_deprecated_request_unit_ix)>>3,
    ...
    .name       = "remove_deprecated_request_unit_ix",
    .cleaned_up = {1, 18, 0} },
  ...
  { .index      = offsetof(fd_features_t, disable_rehash_for_rent_epoch)>>3,
    ...
    .name       = "disable_rehash_for_rent_epoch",
    .cleaned_up = {1, 18, 0} },
  ...
  { .index      = offsetof(fd_features_t, limit_max_instruction_trace_length)>>3,
    ...
    .name       = "limit_max_instruction_trace_length",
    .cleaned_up = {1, 18, 0} },
  ...
  { .index      = offsetof(fd_features_t, check_syscall_outputs_do_not_overlap)>>3,
    ...
    .name       = "check_syscall_outputs_do_not_overlap",
    .cleaned_up = {1, 18, 0} },
  ...
  { .index      = offsetof(fd_features_t, enable_bpf_loader_set_authority_checked_ix)>>3,
    ...
    .name       = "enable_bpf_loader_set_authority_checked_ix",
    .cleaned_up = {UINT_MAX, UINT_MAX, UINT_MAX} },
  ...
  { .index      = offsetof(fd_features_t, commission_updates_only_allowed_in_first_half_of_epoch)>>3,
    ...
    .name       = "commission_updates_only_allowed_in_first_half_of_epoch",
    .cleaned_up = {UINT_MAX, UINT_MAX, UINT_MAX} },
  ...
  { .index      = offsetof(fd_features_t, enable_turbine_fanout_experiments)>>3,
    ...
    .name       = "enable_turbine_fanout_experiments",
    .cleaned_up = {UINT_MAX, UINT_MAX, UINT_MAX} },
  ...
  { .index      = offsetof(fd_features_t, move_serialized_len_ptr_in_cpi)>>3,
    ...
    .name       = "move_serialized_len_ptr_in_cpi",
    .cleaned_up = {1, 18, 0} },
  ...
  { .index      = offsetof(fd_features_t, cap_transaction_accounts_data_size)>>3,
    ...
    .name       = "cap_transaction_accounts_data_size",
    .cleaned_up = {1, 18, 0} },
  ...
  { .index      = offsetof(fd_features_t, enable_request_heap_frame_ix)>>3,
    ...
    .name       = "enable_request_heap_frame_ix",
    .cleaned_up = {1, 18, 0} },
  ...
  { .index      = offsetof(fd_features_t, delay_visibility_of_program_deployment)>>3,
    ...
    .name       = "delay_visibility_of_program_deployment",
    .cleaned_up = {1, 18, 0} },
  ...
  { .index      = offsetof(fd_features_t, add_set_tx_loaded_accounts_data_size_instruction)>>3,
    ...
    .name       = "add_set_tx_loaded_accounts_data_size_instruction",
    .cleaned_up = {1, 18, 0} },
  ...
  { .index      = offsetof(fd_features_t, remove_bpf_loader_incorrect_program_id)>>3,
    ...
    .name       = "remove_bpf_loader_incorrect_program_id",
    .cleaned_up = {1, 18, 0} },
  ...
  { .index      = offsetof(fd_features_t, native_programs_consume_cu)>>3,
    ...
    .name       = "native_programs_consume_cu",
    .cleaned_up = {1, 18, 0} },
  ...
  { .index      = offsetof(fd_features_t, simplify_writable_program_account_check)>>3,
    ...
    .name       = "simplify_writable_program_account_check",
    .cleaned_up = {UINT_MAX, UINT_MAX, UINT_MAX} },
  ...
  { .index      = offsetof(fd_features_t, stop_truncating_strings_in_syscalls)>>3,
    ...
    .name       = "stop_truncating_strings_in_syscalls",
    .cleaned_up = {1, 18, 0} },
  ...
  { .index      = offsetof(fd_features_t, clean_up_delegation_errors)>>3,
    ...
    .name       = "clean_up_delegation_errors",
    .cleaned_up = {UINT_MAX, UINT_MAX, UINT_MAX} },
  ...
  { .index      = offsetof(fd_features_t, vote_state_add_vote_latency)>>3,
    ...
    .name       = "vote_state_add_vote_latency",
    .cleaned_up = {2, 1, 0} },
  ...
  { .index      = offsetof(fd_features_t, checked_arithmetic_in_fee_validation)>>3,
    ...
    .name       = "checked_arithmetic_in_fee_validation",
    .cleaned_up = {1, 18, 0} },
  ...
  { .index      = offsetof(fd_features_t, revise_turbine_epoch_stakes)>>3,
    ...
    .name       = "revise_turbine_epoch_stakes",
    .cleaned_up = {UINT_MAX, UINT_MAX, UINT_MAX} },
  ...
  { .index      = offsetof(fd_features_t, better_error_codes_for_tx_lamport_check)>>3,
    ...
    .name       = "better_error_codes_for_tx_lamport_check",
    .cleaned_up = {UINT_MAX, UINT_MAX, UINT_MAX} },
  ...
  { .index      = offsetof(fd_features_t, enable_alt_bn128_compression_syscall)>>3,
    ...
    .name       = "enable_alt_bn128_compression_syscall",
    .cleaned_up = {UINT_MAX, UINT_MAX, UINT_MAX} },
  ...
  { .index      = offsetof(fd_features_t, validate_fee_collector_account)>>3,
    ...
    .name       = "validate_fee_collector_account",
    .cleaned_up = {2, 1, 0} },
  ...
  { .index      = offsetof(fd_features_t, enable_zk_transfer_with_fee)>>3,
    ...
    .name       = "enable_zk_transfer_with_fee",
    .cleaned_up = {UINT_MAX, UINT_MAX, UINT_MAX} },
  ...
  { .index      = offsetof(fd_features_t, consume_blockstore_duplicate_proofs)>>3,
    ...
    .name       = "consume_blockstore_duplicate_proofs",
    .cleaned_up = {UINT_MAX, UINT_MAX, UINT_MAX} },
  ...
  { .index      = offsetof(fd_features_t, index_erasure_conflict_duplicate_proofs)>>3,
    ...
    .name       = "index_erasure_conflict_duplicate_proofs",
    .cleaned_up = {UINT_MAX, UINT_MAX, UINT_MAX} },
  ...
  { .index      = offsetof(fd_features_t, allow_commission_decrease_at_any_time)>>3,
    ...
    .name       = "allow_commission_decrease_at_any_time",
    .cleaned_up = {UINT_MAX, UINT_MAX, UINT_MAX} },
  ...
  { .index      = offsetof(fd_features_t, merkle_conflict_duplicate_proofs)>>3,
    ...
    .name       = "merkle_conflict_duplicate_proofs",
    .cleaned_up = {UINT_MAX, UINT_MAX, UINT_MAX} },
  ...
  { .index      = offsetof(fd_features_t, disable_bpf_loader_instructions)>>3,
    ...
    .name       = "disable_bpf_loader_instructions",
    .cleaned_up = {UINT_MAX, UINT_MAX, UINT_MAX} },
  ...
  { .index      = offsetof(fd_features_t, enable_zk_proof_from_account)>>3,
    ...
    .name       = "enable_zk_proof_from_account",
    .cleaned_up = {UINT_MAX, UINT_MAX, UINT_MAX} },
  ...
  { .index      = offsetof(fd_features_t, enable_gossip_duplicate_proof_ingestion)>>3,
    ...
    .name       = "enable_gossip_duplicate_proof_ingestion",
    .cleaned_up = {UINT_MAX, UINT_MAX, UINT_MAX} },
  ...
  { .index      = offsetof(fd_features_t, enable_chained_merkle_shreds)>>3,
    ...
    .name       = "enable_chained_merkle_shreds",
    .cleaned_up = {UINT_MAX, UINT_MAX, UINT_MAX} },

  { .index      = offsetof(fd_features_t, remove_rounding_in_fee_calculation)>>3,
...
FD_STATIC_ASSERT( offsetof( fd_features_t, full_inflation_vote                                     )>>3==  3UL, layout );
FD_STATIC_ASSERT( offsetof( fd_features_t, full_inflation_enable                                   )>>3==  4UL, layout );
